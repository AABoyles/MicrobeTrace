(function (global, factory) {
    ...
    function parseMatrix(matrix, labels) {
      ...
      while (that.cN > 2) {
        ...
        if (d1 < 0 || d2 < 0) {
          console.log('that.D' , JSON.stringify(that.D))
          console.log('row sums' , that.rowSums)
          console.log('minI', minI)
          console.log('minJ', minJ)
          console.log('that.D[minI][minJ]', that.D[minI][minJ])
          console.log('that.rowSums[minI]', that.rowSums[minI])
          console.log('that.rowSums[minJ]', that.rowSums[minJ])
          console.log('d1', d1)
          console.log('d2', d2)
